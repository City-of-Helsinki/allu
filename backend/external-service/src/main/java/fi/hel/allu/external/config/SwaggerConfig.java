...
//
//  @Bean
//  public GroupedOpenApi api10(ServletContext servletContext) {
...
//
//  @Bean
//  public GroupedOpenApi api20(ServletContext servletContext) {
...
//  }
//
//  private GroupedOpenApi createApi(ServletContext servletContext, String groupName, String version) {
//    List<SecurityScheme> schemeList = Collections.singletonList(new ApiKey("api_key", "Authorization", "Bearer"));
//
//    SpringDocUtils.getConfig().replaceWithClass(Geometry.class, String.class);
//
