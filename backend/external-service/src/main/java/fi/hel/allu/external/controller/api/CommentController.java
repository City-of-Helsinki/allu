...
public class CommentController {
    ...
    public ResponseEntity<Integer> addComment(
            @Parameter(description = "Id of the application to add comment for.") @PathVariable Integer id,
    ...
    public ResponseEntity<Void> deleteComment(
            @Parameter(description = "Comment id to delete") @PathVariable Integer id) {
    ...
    @PreAuthorize("hasAnyRole('ROLE_INTERNAL','ROLE_TRUSTED_PARTNER')")
    public ResponseEntity<List<CommentOutExt>> getReceivedComments(
            @Parameter(description = "Application id to get comments for") @PathVariable Integer id) {
    ...
    @PreAuthorize("hasAnyRole('ROLE_INTERNAL','ROLE_TRUSTED_PARTNER')")
    public ResponseEntity<List<CommentOutExt>> getSentComments(
            @Parameter(description = "Application id to get comments for") @PathVariable Integer id) {
