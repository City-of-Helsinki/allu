...
public class MailComposerServiceSpec {
...

  {
    describe("Mail composer service", () -> {
      ...
      describe("Create decision e-mail", () -> {
        ...
        it("Continues sending to remaining recipients when saveMailSenderLog fails", () -> {
          ...
          try {
            ...
            // but saveMailSenderLog failures are swallowed
          }
  ...
  private static int distributionIdSequence = 0;
