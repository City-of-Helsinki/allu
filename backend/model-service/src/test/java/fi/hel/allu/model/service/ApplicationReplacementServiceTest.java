...
public class ApplicationReplacementServiceTest {
  ...
  @Test
  public void shouldClearWorkFinishedDatesForExcavationAnnouncement() {
    ...
    assertNull(replacementExtension.getCustomerWorkFinished());
    assertNull(replacementExtension.getWorkFinishedReported());
  }

  @Test
  public void shouldClearWorkFinishedDatesForAreaRental() {
