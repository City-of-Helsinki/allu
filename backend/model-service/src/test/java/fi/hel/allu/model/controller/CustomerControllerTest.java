...
public class CustomerControllerTest {
  ...
  public void addPersonCustomer() throws Exception {
    ...
    ControllerHelper.addPersonCustomer(wtc, "Pekka Pekkala", "pekka@pekkalat.net", null).andExpect(status().isOk());
  }

  @Test
  public void addPersonWithId() throws Exception {
    // add person with id. Should not fail, ignores id and creates new customer:
    ControllerHelper.addPersonCustomer(wtc, "Paavo Ruotsalainen", "ei-oo", 239).andExpect(status().isOk());
  }
  ...
  public void updatePerson() throws Exception {
    ...
    wtc.perform(put(String.format("/customers/%d", result.getId())), newPerson).andExpect(status().isOk())
  ...
  public void updateNonexistent() throws Exception {
    ...
    wtc.perform(put(String.format("/customers/27312")), person).andExpect(status().isNotFound());
  }
}
