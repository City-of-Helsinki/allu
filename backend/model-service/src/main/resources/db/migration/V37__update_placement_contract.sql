...
update allu.application set extension = extension::jsonb - 'generalTerms' || jsonb_build_object('contractText', extension::jsonb->'generalTerms') where type='PLACEMENT_CONTRACT';
...
update allu.application set extension = extension::jsonb - 'diaryNumber' || jsonb_build_object('identificationNumber', extension::jsonb->'diaryNumber') where type='PLACEMENT_CONTRACT';
