...
public class ApplicationStatusController {
  ...
  public ResponseEntity<Application> changeStatusToPreReserved(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.PRE_RESERVED, null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToPending(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.PENDING, null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToHandling(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.HANDLING, null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToReturnedToPreparation(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.RETURNED_TO_PREPARATION, null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToDecisionMaking(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.DECISIONMAKING, null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToDecision(@PathVariable int id, @RequestBody Integer userId) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.DECISION, userId), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToRejected(@PathVariable int id, @RequestBody Integer userId) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.REJECTED, userId), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToFinished(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.FINISHED, null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Application> changeStatusToCancelled(@PathVariable int id) {
    return new ResponseEntity<>(applicationService.changeApplicationStatus(id, StatusType.CANCELLED, null), HttpStatus.OK);
  }
}
