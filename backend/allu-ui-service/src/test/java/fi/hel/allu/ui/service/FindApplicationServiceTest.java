...
public class FindApplicationServiceTest {
    ...
    public void testFindApplicationById() {
        Mockito.when(restTemplate.getForObject(Mockito.any(String.class), Mockito.eq(ApplicationDTO.class), Mockito.any(String.class)))
        ...
        Mockito.verify(restTemplate, Mockito.times(1)).getForObject(Mockito.any(String.class), Mockito.eq(ApplicationDTO.class), Mockito
                .any(String.class));
