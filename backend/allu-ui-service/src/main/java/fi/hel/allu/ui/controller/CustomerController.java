...
public class CustomerController {
  ...
  /**
   * Returns a paginated list of ustomers eligible for permanent deletion.
   * A customer is deletable if it (or its related contacts) is not linked to any application or project in Allu.
