...
public class TestData {
 ...
 public static final Geometry NOTE_GEOMETRY = geometrycollection(3879, polygon(ring(
     c(2.5496711621E7, 6673838.878523142),
     c(2.5496711655E7, 6673876.2026385255),
     c(2.5496741015E7, 6673876.1764160935),
     c(2.5496740981E7, 6673838.85230053),
     c(2.5496711621E7, 6673838.878523142))));
}