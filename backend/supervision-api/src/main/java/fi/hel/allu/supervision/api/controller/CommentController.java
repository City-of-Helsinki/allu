...
public class CommentController {
  ...
  @RequestMapping(value = "/applications/{id}/comments", method = RequestMethod.POST,  produces = "application/json", consumes = "application/json")
  ...
  @RequestMapping(value = "/projects/{id}/comments", method = RequestMethod.POST, produces = "application/json", consumes = "application/json")
  @PreAuthorize("hasAnyRole('ROLE_SUPERVISE')")
  ...
  @RequestMapping(value = "/applications/{id}/comments", method = RequestMethod.GET, produces = "application/json")
  ...
  @RequestMapping(value = "/projects/{id}/comments", method = RequestMethod.GET, produces = "application/json")
  @PreAuthorize("hasAnyRole('ROLE_SUPERVISE', 'ROLE_VIEW')")
