...
@Schema(name = "Supervision task search parameters",
     description =
        "<ul>"
      ...
      +     "<li><b>Key</b>: VALID_AFTER, <b>value:</b> Planned finishing time after given date time. Date-time with an offset, eg '2011-12-03T10:15:30+01:00'</li>"
      +     "<li><b>Key</b>: VALID_BEFORE, <b>value:</b> Planned finishing time before given date time. Date-time with an offset, eg '2011-12-03T10:15:30+01:00'</li>"
      +   "</ul>"
      + "</li>"
