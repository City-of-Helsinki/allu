...
describe('DefaultRecipientHub', () => {
  ...
  it('should be empty after initialization', fakeAsync(() => {
    tick();
    hub.defaultRecipients.subscribe(recipients => expect(recipients.length === 0));
  }));

  it('should emit values when load is called', fakeAsync(() => {
