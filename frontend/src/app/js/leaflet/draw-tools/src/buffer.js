 ...
 * @param {number} [options.endCapStyle] style of polygons end cap
...
function buffer(geojson, radius, options) {
  ...
  var endCapStyle = options.endCapStyle || BufferOp.CAP_FLAT;
  ...
  switch (geojson.type) {
    ...
    case 'FeatureCollection':
      featureEach(geojson, function (feature) {
        var multiBuffered = bufferFeature(feature, radius, units, steps, endCapStyle);
        if (multiBuffered) {
