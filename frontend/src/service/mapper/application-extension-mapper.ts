...
export class ApplicationExtensionMapper {
  ...
  private static mapFrontendEvent(event: Event): any {
    return {
        ...
        noPriceReason: event.entryFee,
        salesActivity: event.salesActivity,
        heavyStructure: event.heavyStructure,
  ...
  private static mapFrontendExcavationAnnouncement(excavation: ExcavationAnnouncement): any {
    return {
      ...
      summerTimeOperation: TimeUtil.dateToBackend(excavation.summerTimeOperation),
